...
honestidad aplicamos cinco pruebas exigentes sobre el S&P 500 (1991-01-02 → 2026-07-29).
...
| 1 mes (21 sesiones) | 0.6% | -0.0% | **0.1819** |
...
| Métrica | Valor |
|---|---|
| Sharpe observado (mejor config, anualizado) | 0.78 |
...
|---|---|---|---|---|
| **Semáforo walk-forward (OOS)** | 6.7% | 11.4% | 0.62 | -19% |
| Comprar y mantener (mismo tramo) | 6.8% | 19.2% | 0.44 | -57% |

Tramo evaluado: 1998-12-22 → 2026-07-29.
...
|---|---|---|---|
| 0 pb | Sharpe 0.74 | Sharpe 0.78 | Sharpe 0.83 |
| 5 pb | Sharpe 0.74 | Sharpe 0.78 | Sharpe 0.83 |
| 10 pb | Sharpe 0.74 | Sharpe 0.78 | Sharpe 0.83 |
| 25 pb | Sharpe 0.74 | Sharpe 0.78 | Sharpe 0.83 |
...
- **Significancia:** la señal NO alcanza significancia estándar a 3 meses (p=0.1493); tratar con cautela.
- **Multiple-testing:** supera el Sharpe deflactado (DSR=100.0%): el resultado no es un artefacto de probar 486 configuraciones.
- **Fuera de muestra:** en walk-forward el Sharpe es 0.62 frente a 0.44 de comprar-y-mantener, con caída máxima -19% vs -57%.
